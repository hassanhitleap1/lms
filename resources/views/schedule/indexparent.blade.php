                    ...
                    <div class="dataTables_wrapper form-inline dt-bootstrap">
                                    ...
                                    <form class="form-horizontal">
                                        <div class="row clearfix">
                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3 form-control-label">
                                                <label class="float-left">@lang('Students')</label>
                                            </div>
                                                        ...
                                                        <select id="Division" class="form-control show-tick">
                                                            <option value="">----------</option>
                                                                @foreach($childs as $child)
                                                                    <?php $select = '' ?>
                                                                    @if($Division==$child['class'])
                                                                        <?php $select = 'selected' ?>
                                                                    @endif
                                                                    <option {{$select}}  att="{{$child['class']}}"

                                                                            value="{{$child['class']}}"><?=$child['fullname']?></option>
                                                                @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4 float-right">
                                @if(\App\Users::isManhalAdmin() or \App\Users::isSchoolManger() or \App\Users::isSchoolManger())
