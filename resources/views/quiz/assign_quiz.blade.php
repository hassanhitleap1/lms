@section('title', 'Add')
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="page_content_quiz_ass" data-id="{{$quiz->quiz_id}}">
    <!-- Nav tabs -->
    <ul class="nav nav-tabs tab-nav-right" role="tablist">
        <li role="presentation" class="{{($tab=='group')? 'active':''}}"><a href="#home_animation_2" data-toggle="tab" id="assignStudent">@lang('lang.Group')</a></li>
    ...
    <!-- Tab panes -->
    <form id="edit-form" action="{{URL::to('/').'/'.Lang::getLocale().'/quiz/'.$quiz->quiz_id.'/save-assign'}}"  method="POST">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <div class="form-group">
                                        <div class="form-line float-left">
                                            <select class="form-control show-tick jq_formdata" id="level-quiz-tab-class">
                                            ...
                                            <form class="form-horizontal">
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                        <div class="form-group">
                                                            <div class="form-line float-left">
                                                                <select class="form-control show-tick " id="level-quiz-std"  >
                                            ...
                                            <form class="form-horizontal">
                                                <div class="row clearfix">
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
                                                        <div class="form-group">
                                                            <div class="form-line float-left">
                                                                <select class="form-control show-tick"  id="class-quiz-std">
