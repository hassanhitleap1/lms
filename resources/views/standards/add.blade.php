@section('title', 'Add')
<form id="edit-form" action="{{URL::to('/').'/'.Lang::getLocale().'/standards/save'}}"  method="POST">
<div class="row clearfix">
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <div class="form-group">
            <div class="form-line">
                <label>@lang('lang.Standard_Number')</label>
                <input type="text" class="form-control" placeholder="@lang('lang.Standard_Number')" name="standard_number" />
            </div>
        </div>
    </div>
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
     ...
     <div class="modal-footer">
            <button class="btn btn-primary waves-effect pull-right" type="button"  id="add_standard" >@lang('lang.Save')</button>
        </div>
