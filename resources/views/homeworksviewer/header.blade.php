...
<head>
    ...
    <script src="{{ asset('js/homeworkviwer.js')}}"></script>
</head>
...
<!-- Top Bar -->
<nav class="navbar">
    <div class="container-fluid homework" id="homework-viewer" homeworkid="{{$homework->homework_id}}" >
        <div class="col-sm-12 col-lg-12 col-md-12">
            <div class="col-sm-5 col-lg-5 col-md-5 float-left">
                <?php $hom=(Array)$homework;
                $arr=config('lms.Categories');
                ?>
                <div class="category-icon-container float-left" title="@lang('lang.Homework')" style="background-image:url(/images/cat2/1.svg);">

                </div>
                <h1 class="lesson-title-container float-left" title="@lang('lang.Homework')"><?= $homework->title;?></h1>
                <div class="separateing-line-container float-left"></div>
                <label class="level-title-container float-left" title="@lang('lang.Level')"><?= $hom['title_'.Lang::getLocale()];?></label>
            </div>
            <div class="col-sm-7 col-lg-7 col-md-7 float-right">
                <div class="float-right">
                    ...
                    <div class="separateing-line-container float-left"></div>
                    <div class="points-awards-container float-left" title="@lang('lang.Awards')">
