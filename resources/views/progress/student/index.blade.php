...
@section('content')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            google.charts.setOnLoadCallback(drawCaregoriers);
            google.charts.setOnLoadCallback(drawProgressDitalies);
