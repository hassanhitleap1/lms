    ...
    <div class="container-fluid">
            <div class="col-sm-12 col-lg-12 col-md-12">
                <div class="col-sm-5 col-lg-5 col-md-5 float-left">
                    ...
                    ?>
                    <div class="category-icon-container float-left" title="<?=$ls['title_en'];?>" style="background-image:url(/images/cat2/{{(isset($arr[$ls['title_en']]))?$ls['title_en']:''}}.svg);">
                ...
                <div class="col-sm-7 col-lg-7 col-md-7 float-right">
                    <div class="float-right">
                        ...
                        <div class="separateing-line-container float-left"></div>
                        <div class="exit-container float-left viewer-exit"></div>
                    </div>
                </div>
            </div>
    </div>
